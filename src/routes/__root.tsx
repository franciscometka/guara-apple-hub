    ...
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Essa página não existe ou foi movida. Volta pro início ou chama a gente no WhatsApp.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Deu algum problema aqui do nosso lado. Tenta de novo ou volta pro início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Guara iPhones" },
      { property: "og:site_name", content: "Guara iPhones" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <a
        href="#conteudo"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-100 focus:inline-flex focus:min-h-11 focus:items-center focus:rounded-md focus:bg-violet focus:px-4 focus:py-2 focus:text-white"
      >
        Ir para o conteúdo
      </a>
      <ScrollProgress />
